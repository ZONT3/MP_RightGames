...
force ace_csw_progressBarTimeCoefficent = 0.1;
...
ace_ui_hideDefaultActionIcon = true;
...
force ace_medical_AIDamageThreshold = 0.95;
force ace_medical_bleedingCoefficient = 0.32283;
...
force ace_medical_dropWeaponUnconsciousChance = 0.05;
force ace_medical_enableVehicleCrashes = true;
force ace_medical_engine_damagePassThroughEffect = 0.8;
...
force ace_medical_painUnconsciousThreshold = 0.599389;
force ace_medical_playerDamageThreshold = 0.95;
...
force ace_medical_treatment_timeCoefficientPAK = 0.25;
...
force ace_medical_treatment_woundReopenChance = 0.3;
force ace_medical_treatment_woundStitchTime = 5;

// ACE ÐœÐµÐ´Ð¸Ñ†Ð¸Ð½Ð° Ð˜Ð½Ñ‚ÐµÑ€Ñ„ÐµÐ¹Ñ
...
force ace_common_checkPBOsWhitelist = "['extDB3','Ca','fxp_VehEXPEffect','fxp_vehExpEffectBig','fxp_vehHeli','fxp_VehPlane','Tracer_C_F','WarFXPE_Weps','fxp_VehTank','WarFXPE','Blastcore_MainCore','ASBE','fxp_adat','blast_refract','Blastcore_VEP','Tracer_ASBE','JSRS_Soundmod_Soundfiles','JSRS_Soundmod_Configuration','jsrs_soundmod_cfg_rhs_afrf_weapons','JSRS_Soundmod_Cfg_RHS_GREF_Weapons','jsrs_soundmod_complete_edition_soundfiles','jsrs_soundmod_complete_edition','jsrs_soundmod_boats','jsrs_soundmod_sonic_cracks','jsrs_soundmod_weapons','jsrs_soundmod_environment','jsrs_soundmod_explosions','jsrs_soundmod_framework','jsrs_soundmod_landvehicles','jsrs_soundmod_movement','jsrs_soundmod_bullethits','jsrs_soundmod_helicopters','jsrs_soundmod_rhs_afrf_weapons','jsrs_soundmod_cfg_rhs_afrf_vehicles','jsrs_soundmod_cfg_rhs_afrf_air_vehicles','jsrs_soundmod_rhs_gref_weapons','ANZ_missileEfxMod','DEVGRU_RedSquadron_Cracks','DEVGRU_RedSquadron_Sounds','DEVGRU_RedSquadron_Weapons_Base',jsrs_soundmod_ce_reloadingsounds','jsrs_soundmod_reloadingsounds',jsrs_soundmod_rhs_usf_weapons','jsrs_soundmod_cfg_rhs_usf_weapons','jsrs_soundmod_cfg_rhs_usf_vehicles','jsrs_soundmod_cfg_rhs_usf_air_vehicles','DEVGRU_RedSquadron_CQB_Objects','jsrs_soundmod_rhs_saf_weapons']";
...
force ace_winddeflection_simulationInterval = 0.0484964;
...
// ACE ÐŸÐµÑ€ÐµÐ¿Ð°ÐºÐ¾Ð²ÐºÐ° Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ð¾Ð²
...
force ace_pylons_timePerPylon = 5.31301;
...
force acex_field_rations_timeWithoutWater = 9;
...
ace_advanced_fatigue_deployedSwayFactor = 0.2;
...
ace_advanced_fatigue_restedSwayFactor = 0.2;
force ace_advanced_fatigue_swayFactor = 0.2;
force ace_advanced_fatigue_terrainGradientFactor = 0.5;

// ACE ÐŸÑ€Ð¾Ð´Ð²Ð¸Ð½ÑƒÑ‚Ð¾Ðµ Ð¿Ð¾Ð²Ñ€ÐµÐ¶Ð´ÐµÐ½Ð¸Ðµ Ñ‚ÐµÑ…Ð½Ð¸ÐºÐ¸
...
force ace_repair_repairDamageThreshold = 0.1;
force ace_repair_repairDamageThreshold_engineer = 0.1;
...
// ACE Pharmacy - AED
aceP_circulation_CPR_Chance_Default = 20;
aceP_circulation_CPR_Chance_Doctor = 40;
aceP_circulation_CPR_Chance_RegularMedic = 30;
aceP_circulation_DeactMon_whileAED_X = true;
aceP_circulation_distanceLimit_AEDX = 30;
aceP_circulation_enable_CPR_Chances = true;
force aceP_circulation_medLvl_AED_X = 0;
aceP_circulation_SuccesCh_AED = 80;
aceP_circulation_SuccesCh_AED_X = 85;
aceP_circulation_timeLimit_AEDX = 1800;
aceP_circulation_useLocation_AED = 0;

// ACE Pharmacy - Fractures
aceP_circulation_closedLocation = 0;
force aceP_circulation_closedReduction = 0;
aceP_circulation_closedTime = 10;
aceP_circulation_compoundChance = 30;
aceP_circulation_enable_fracture = true;
aceP_circulation_etomidateTime = 45;
aceP_circulation_fractureCheck_Level = 0;
aceP_circulation_incisionTime = 10;
aceP_circulation_openTime = 15;
aceP_circulation_simpleChance = 60;
aceP_circulation_surgicalAction = 2;
aceP_circulation_surgicalLocation = 3;
aceP_circulation_surgicalTime = 8;

// ACE Pharmacy - Medications
aceP_circulation_aiEnableAdvanced = false;
aceP_circulation_blockChance = 20;
aceP_circulation_coagulation = true;
aceP_circulation_factorDrugs = 2;
aceP_circulation_IOestablish = 7;
aceP_circulation_IVdrop = 600;
aceP_circulation_IVdropEnable = true;
aceP_circulation_IVestablish = 7;
force aceP_circulation_IVmedic = 0;
aceP_circulation_IVreuse = false;
aceP_circulation_kidneyAction = false;
aceP_circulation_maxStack = 5;
aceP_circulation_PushTime = 7;
aceP_circulation_surgicalDrugs = 2;
aceP_circulation_vasoDrugs = 1;
...
CBRN_factionMask_Aaren_Modules = "";
CBRN_factionMask_ACM_B_CDF = "";
CBRN_factionMask_ACM_O_SZAVB = "";
CBRN_factionMask_B_AUS = "";
CBRN_factionMask_B_CIA = "";
CBRN_factionMask_B_MACV = "";
CBRN_factionMask_B_MEDT = "";
CBRN_factionMask_B_NZ = "";
CBRN_factionMask_B_ROK = "";
CBRN_factionMask_BLU_CTRG_F = "";
CBRN_factionMask_BLU_F = "";
CBRN_factionMask_BLU_G_F = "";
CBRN_factionMask_BLU_GEN_F = "";
CBRN_factionMask_BLU_GSB = "";
CBRN_factionMask_BLU_GSB_CDF = "";
CBRN_factionMask_BLU_T_F = "";
CBRN_factionMask_BLU_W_F = "";
CBRN_factionMask_C_VIET = "";
CBRN_factionMask_CDF_2020 = "";
...
CBRN_factionMask_CUP_B_GER = "";
CBRN_factionMask_CUP_B_HIL = "";
...
CBRN_factionMask_CUP_O_TK = "";
CBRN_factionMask_CUP_O_TK_MILITIA = "";
CBRN_factionMask_Delta_CO_75th = "";
CBRN_factionMask_EMP_Greystone_PMC = "";
CBRN_factionMask_fsog3_faction = "";
CBRN_factionMask_Horror_Units_F = "";
CBRN_factionMask_I_ARVN = "";
CBRN_factionMask_I_CAM = "";
CBRN_factionMask_I_LAO = "";
CBRN_factionMask_IND_C_F = "";
CBRN_factionMask_IND_E_F = "";
CBRN_factionMask_IND_F = "";
CBRN_factionMask_IND_G_F = "";
CBRN_factionMask_IND_L_F = "";
CBRN_factionMask_IND_P_F = "";
CBRN_factionMask_Interactive_F = "";
CBRN_factionMask_Moe_Faction = "";
CBRN_factionMask_O_CAM = "";
CBRN_factionMask_O_PAVN = "";
CBRN_factionMask_O_PL = "";
CBRN_factionMask_O_VC = "";
CBRN_factionMask_OPF_F = "";
CBRN_factionMask_OPF_G_F = "";
CBRN_factionMask_OPF_GEN_F = "";
CBRN_factionMask_OPF_R_F = "";
CBRN_factionMask_OPF_T_F = "";
CBRN_factionMask_OPF_V_F = "";
CBRN_factionMask_rhs_faction_insurgents = "";
CBRN_factionMask_rhs_faction_msv = "";
CBRN_factionMask_rhs_faction_rva = "";
...
CBRN_factionMask_rhs_faction_usarmy_d = "";
CBRN_factionMask_rhs_faction_usarmy_wd = "";
CBRN_factionMask_rhs_faction_usmc = "";
CBRN_factionMask_rhs_faction_usmc_d = "";
CBRN_factionMask_rhs_faction_usmc_wd = "";
CBRN_factionMask_rhs_faction_usn = "";
CBRN_factionMask_rhs_faction_vdv = "";
CBRN_factionMask_rhs_faction_vdv_45 = "";
CBRN_factionMask_rhs_faction_vmf = "";
CBRN_factionMask_rhs_faction_vpvo = "";
CBRN_factionMask_rhs_faction_vv = "";
CBRN_factionMask_rhs_faction_vvs = "";
CBRN_factionMask_rhs_faction_vvs_c = "";
CBRN_factionMask_rhsgref_faction_cdf_air = "";
CBRN_factionMask_rhsgref_faction_cdf_air_b = "";
CBRN_factionMask_rhsgref_faction_cdf_ground = "";
CBRN_factionMask_rhsgref_faction_cdf_ground_b = "";
CBRN_factionMask_rhsgref_faction_cdf_ng = "";
CBRN_factionMask_rhsgref_faction_cdf_ng_b = "";
CBRN_factionMask_rhsgref_faction_chdkz = "";
CBRN_factionMask_rhsgref_faction_chdkz_g = "";
CBRN_factionMask_rhsgref_faction_hidf = "";
CBRN_factionMask_rhsgref_faction_nationalist = "";
CBRN_factionMask_rhsgref_faction_tla = "";
CBRN_factionMask_rhsgref_faction_tla_g = "";
CBRN_factionMask_rhsgref_faction_un = "";
CBRN_factionMask_rhssaf_faction_airforce = "";
CBRN_factionMask_rhssaf_faction_airforce_opfor = "";
CBRN_factionMask_rhssaf_faction_army = "";
CBRN_factionMask_rhssaf_faction_army_opfor = "";
CBRN_factionMask_rhssaf_faction_un = "";
CBRN_factionMask_T_CDF = "";
CBRN_factionMask_T_CDF_UN = "";
CBRN_factionMask_UK3CB_AAF_B = "";
CBRN_factionMask_UK3CB_AAF_I = "";
CBRN_factionMask_UK3CB_AAF_O = "";
CBRN_factionMask_UK3CB_ADA_B = "";
CBRN_factionMask_UK3CB_ADA_I = "";
CBRN_factionMask_UK3CB_ADA_O = "";
CBRN_factionMask_UK3CB_ADC_B = "";
CBRN_factionMask_UK3CB_ADC_C = "";
CBRN_factionMask_UK3CB_ADC_I = "";
CBRN_factionMask_UK3CB_ADC_O = "";
CBRN_factionMask_UK3CB_ADE_I = "";
CBRN_factionMask_UK3CB_ADE_O = "";
CBRN_factionMask_UK3CB_ADG_B = "";
CBRN_factionMask_UK3CB_ADG_I = "";
CBRN_factionMask_UK3CB_ADG_O = "";
CBRN_factionMask_UK3CB_ADM_B = "";
CBRN_factionMask_UK3CB_ADM_I = "";
CBRN_factionMask_UK3CB_ADM_O = "";
CBRN_factionMask_UK3CB_ADP_B = "";
CBRN_factionMask_UK3CB_ADP_I = "";
CBRN_factionMask_UK3CB_ADP_O = "";
CBRN_factionMask_UK3CB_ADR_B = "";
CBRN_factionMask_UK3CB_ADR_I = "";
CBRN_factionMask_UK3CB_ADR_O = "";
CBRN_factionMask_UK3CB_ANA_B = "";
CBRN_factionMask_UK3CB_ANP_B = "";
CBRN_factionMask_UK3CB_APD_B = "";
CBRN_factionMask_UK3CB_APD_I = "";
CBRN_factionMask_UK3CB_APD_O = "";
CBRN_factionMask_UK3CB_ARD_B = "";
CBRN_factionMask_UK3CB_ARD_I = "";
CBRN_factionMask_UK3CB_ARD_O = "";
CBRN_factionMask_UK3CB_CCM_B = "";
CBRN_factionMask_UK3CB_CCM_I = "";
CBRN_factionMask_UK3CB_CCM_O = "";
CBRN_factionMask_UK3CB_CHC_B = "";
CBRN_factionMask_UK3CB_CHC_C = "";
CBRN_factionMask_UK3CB_CHC_I = "";
CBRN_factionMask_UK3CB_CHC_O = "";
CBRN_factionMask_UK3CB_CHD_B = "";
CBRN_factionMask_UK3CB_CHD_I = "";
CBRN_factionMask_UK3CB_CHD_O = "";
CBRN_factionMask_UK3CB_CHD_W_B = "";
CBRN_factionMask_UK3CB_CHD_W_I = "";
CBRN_factionMask_UK3CB_CHD_W_O = "";
...
CBRN_factionMask_UK3CB_FIA_B = "";
CBRN_factionMask_UK3CB_FIA_I = "";
CBRN_factionMask_UK3CB_FIA_O = "";
CBRN_factionMask_UK3CB_GAF_B = "";
CBRN_factionMask_UK3CB_GAF_I = "";
CBRN_factionMask_UK3CB_GAF_O = "";
CBRN_factionMask_UK3CB_ION_B_Desert = "";
CBRN_factionMask_UK3CB_ION_B_Urban = "";
CBRN_factionMask_UK3CB_ION_B_Winter = "";
CBRN_factionMask_UK3CB_ION_B_Woodland = "";
CBRN_factionMask_UK3CB_ION_I_Desert = "";
CBRN_factionMask_UK3CB_ION_I_Urban = "";
CBRN_factionMask_UK3CB_ION_I_Winter = "";
CBRN_factionMask_UK3CB_ION_I_Woodland = "";
CBRN_factionMask_UK3CB_ION_O_Desert = "";
CBRN_factionMask_UK3CB_ION_O_Urban = "";
CBRN_factionMask_UK3CB_ION_O_Winter = "";
CBRN_factionMask_UK3CB_ION_O_Woodland = "";
CBRN_factionMask_UK3CB_KDF_B = "";
CBRN_factionMask_UK3CB_KDF_I = "";
CBRN_factionMask_UK3CB_KDF_O = "";
CBRN_factionMask_UK3CB_KRG_B = "";
CBRN_factionMask_UK3CB_KRG_I = "";
CBRN_factionMask_UK3CB_KRG_O = "";
CBRN_factionMask_UK3CB_LDF_B = "";
CBRN_factionMask_UK3CB_LDF_I = "";
CBRN_factionMask_UK3CB_LDF_O = "";
CBRN_factionMask_UK3CB_LFR_B = "";
CBRN_factionMask_UK3CB_LFR_I = "";
CBRN_factionMask_UK3CB_LFR_O = "";
CBRN_factionMask_UK3CB_LNM_B = "";
CBRN_factionMask_UK3CB_LNM_I = "";
CBRN_factionMask_UK3CB_LNM_O = "";
CBRN_factionMask_UK3CB_LSM_B = "";
CBRN_factionMask_UK3CB_LSM_I = "";
CBRN_factionMask_UK3CB_LSM_O = "";
CBRN_factionMask_UK3CB_MDF_B = "";
CBRN_factionMask_UK3CB_MDF_I = "";
CBRN_factionMask_UK3CB_MDF_O = "";
CBRN_factionMask_UK3CB_MEE_I = "";
CBRN_factionMask_UK3CB_MEE_O = "";
CBRN_factionMask_UK3CB_MEI_B = "";
CBRN_factionMask_UK3CB_MEI_I = "";
CBRN_factionMask_UK3CB_MEI_O = "";
CBRN_factionMask_UK3CB_NAP_B = "";
CBRN_factionMask_UK3CB_NAP_I = "";
CBRN_factionMask_UK3CB_NAP_O = "";
CBRN_factionMask_UK3CB_NFA_B = "";
CBRN_factionMask_UK3CB_NFA_I = "";
CBRN_factionMask_UK3CB_NFA_O = "";
CBRN_factionMask_UK3CB_NPD_B = "";
CBRN_factionMask_UK3CB_NPD_I = "";
CBRN_factionMask_UK3CB_NPD_O = "";
CBRN_factionMask_UK3CB_TKA_B = "";
CBRN_factionMask_UK3CB_TKA_I = "";
CBRN_factionMask_UK3CB_TKA_O = "";
CBRN_factionMask_UK3CB_TKC_B = "";
CBRN_factionMask_UK3CB_TKC_C = "";
CBRN_factionMask_UK3CB_TKC_I = "";
CBRN_factionMask_UK3CB_TKC_O = "";
CBRN_factionMask_UK3CB_TKM_B = "";
CBRN_factionMask_UK3CB_TKM_I = "";
CBRN_factionMask_UK3CB_TKM_O = "";
CBRN_factionMask_UK3CB_TKP_B = "";
CBRN_factionMask_UK3CB_TKP_I = "";
...
CBRN_factionMask_VX_WAF_CSAT = "";
CBRN_factionMask_VX_WAF_NATO = "";
CBRN_factionMask_WBK_AI = "";
CBRN_factionMask_WBK_AI_Melee = "";
CBRN_factionMask_Wolfram_3CB_BAF_F = "";
CBRN_factionMask_Wolfram_AFRF_F = "";
CBRN_factionMask_Wolfram_Arg_F = "";
CBRN_factionMask_Wolfram_Dutch_F = "";
CBRN_factionMask_Wolfram_France_F = "";
CBRN_factionMask_Wolfram_Generic_F = "";
CBRN_factionMask_Wolfram_GM_F = "";
CBRN_factionMask_Wolfram_Italy_F = "";
CBRN_factionMask_Wolfram_PL_F = "";
CBRN_factionMask_Wolfram_PLA_F = "";
CBRN_factionMask_Wolfram_Roslav_F = "";
CBRN_factionMask_Wolfram_Sweden_F = "";
CBRN_factionMask_Wolfram_USA_F = "";
CBRN_factionMask_Wolfram_USMC_F = "";
...
// DUI - Ð Ð°Ð´Ð°Ñ€ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñ‹ - Ð˜Ð½Ð´Ð¸ÐºÐ°Ñ‚Ð¾Ñ€Ñ‹
...
// DUI - Ð Ð°Ð´Ð°Ñ€ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñ‹ - ÐžÑÐ½Ð¾Ð²Ð½Ð¾Ðµ
...
// DUI - Ð Ð°Ð´Ð°Ñ€ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñ‹ - Ð Ð°Ð´Ð°Ñ€
...
FSPLUS_CW_AsphyxiantGas = true;
FSPLUS_CW_CSGas = true;
FSPLUS_CW_NerveGas = true;
FSPLUS_CW_RemoveExposure = true;
...
force grad_trenches_functions_vehicleEnvelopeDigTime = 90;
...
force stx_common_autoParachute = true;
force stx_common_hintType = 2;
...
force stx_logistics_flashingFrequency = 0.4;
...
force stx_logistics_visualAid = 3;

// STX Main
force stx_main_debug = false;
...
force stx_military_debug = false;
...
force TFAR_Teamspeak_Channel_Name = "RG_TFAR";
force TFAR_Teamspeak_Channel_Password = "123454321";
force tfar_terrain_interception_coefficient = 5;
...
usaf_f35a_allow_das_coverage = true;
usaf_f35a_allow_sar_imagery = true;
...
heliIN_sdr = 100;
heliMulti_sdr = 1;
planeBreathe_sdr = 100;
planeEX_sdr = 100;
planeEX_sim_sdr = 25;
planeIN_sdr = 100;
planeMulti_sdr = 1;
planeRumbleG_sdr = 100;
SoIV_fn = false;
sync_fn = false;
sync_heli_sdr = 100;
sync_plane_sdr = 100;
...
// Zeus Enhanced - ÐÑ‚Ñ€Ð¸Ð±ÑƒÑ‚Ñ‹
force zen_attributes_enableAbilities = true;
force zen_attributes_enableAmmo = true;
force zen_attributes_enableArsenal = true;
force zen_attributes_enableBuildingMarker = true;
force zen_attributes_enableDamage = true;
force zen_attributes_enableEngine = true;
force zen_attributes_enableExecute = true;
force zen_attributes_enableFuel = true;
force zen_attributes_enableGarage = true;
force zen_attributes_enableGroupBehaviour = true;
force zen_attributes_enableGroupCombatMode = true;
force zen_attributes_enableGroupExecute = true;
force zen_attributes_enableGroupFormation = true;
force zen_attributes_enableGroupID = true;
force zen_attributes_enableGroupSide = true;
force zen_attributes_enableGroupSkill = true;
force zen_attributes_enableGroupSpeed = true;
force zen_attributes_enableGroupStance = true;
force zen_attributes_enableHealth = true;
force zen_attributes_enableInventory = true;
force zen_attributes_enableLights = true;
force zen_attributes_enableMarkerAlpha = true;
force zen_attributes_enableMarkerColor = true;
force zen_attributes_enableMarkerText = true;
force zen_attributes_enableName = true;
force zen_attributes_enablePlateNumber = true;
force zen_attributes_enableRank = true;
force zen_attributes_enableRespawnPosition = true;
force zen_attributes_enableRespawnVehicle = true;
force zen_attributes_enableSensors = true;
force zen_attributes_enableSkill = true;
force zen_attributes_enableSkills = true;
force zen_attributes_enableStance = true;
force zen_attributes_enableStates = true;
force zen_attributes_enableTraits = true;
force zen_attributes_enableVehicleLock = true;
force zen_attributes_enableWaypointBehaviour = true;
force zen_attributes_enableWaypointCombatMode = true;
force zen_attributes_enableWaypointFormation = true;
force zen_attributes_enableWaypointLoiterAltitude = true;
force zen_attributes_enableWaypointLoiterDirection = true;
force zen_attributes_enableWaypointLoiterRadius = true;
force zen_attributes_enableWaypointSpeed = true;
force zen_attributes_enableWaypointTimeout = true;
force zen_attributes_enableWaypointType = true;

// Zeus Enhanced - Faction Filter
zen_faction_filter_0_ACM_O_SZAVB = true;
...
force zen_faction_filter_0_rhs_faction_vmf_groups = true;
...
zen_faction_filter_0_VX_WAF_CSAT = true;
zen_faction_filter_0_WBK_AI = true;
zen_faction_filter_0_WBK_AI_Melee = true;
zen_faction_filter_1_ACM_B_CDF = true;
...
zen_faction_filter_1_BLU_GSB = true;
zen_faction_filter_1_BLU_GSB_CDF = true;
force zen_faction_filter_1_BLU_T_F = true;
force zen_faction_filter_1_BLU_W_F = true;
zen_faction_filter_1_CDF_2020 = true;
zen_faction_filter_1_Delta_CO_75th = true;
...
zen_faction_filter_1_T_CDF = true;
...
zen_faction_filter_1_VX_WAF_NATO = true;
...
zen_faction_filter_2_T_CDF_UN = true;
...
kat_airway_block_turnAround_ifAirwayItem = true;
...
kat_breathing_BVMTime = 15;
kat_breathing_cyanosisShowInMenu = false;
kat_breathing_deterioratingPneumothorax_chance = 10;
kat_breathing_deterioratingPneumothorax_countdown = 120;
kat_breathing_enable = false;
kat_breathing_enable_selfChestseal = 1;
kat_breathing_enableCyanosis = false;
kat_breathing_enableSPO2Flashing = true;
kat_breathing_HPTXBleedAmount = 0.06;
kat_breathing_hptxChance = 5;
kat_breathing_locationProvideOxygen = 3;
kat_breathing_lowSPO2Level = 90;
kat_breathing_medLvl_BVM = 0;
kat_breathing_medLvl_BVM_Oxygen = 0;
kat_breathing_medLvl_Chestseal = 0;
kat_breathing_medLvl_Cyanosis = 0;
kat_breathing_medLvl_hemopneumothoraxTreatment = 0;
kat_breathing_medLvl_PocketBVM = 0;
...
kat_circulation_AED_MinChance = 40;
kat_circulation_AED_X_AttachTime = 10;
kat_circulation_AED_X_DetachTime = 5;
kat_circulation_AED_X_MaxChance = 90;
kat_circulation_AED_X_MinChance = 45;
kat_circulation_AED_X_Monitor_NoHeartRate = 0;
...
kat_misc_allowSharedVehicleEquipment = 0;
...
kat_misc_arsenalMedCategory = true;
kat_misc_enable = true;
kat_misc_incompatibilityWarning = true;
kat_misc_neckTourniquet = false;
...
kat_pharma_chromatic_aberration_checkbox_ketamine = true;
kat_pharma_chromatic_aberration_checkbox_pervitin = true;
kat_pharma_chromatic_aberration_slider_fentanyl = 1;
kat_pharma_chromatic_aberration_slider_ketamine = 0.8;
kat_pharma_chromatic_aberration_slider_pervitin = 1;
kat_pharma_coagulation = false;
...
kat_pharma_reorientationChance = 100;
...
kat_surgery_BreathCheck_MedLevel = 0;
kat_surgery_BreathCheck_Time = 2;
...
kat_surgery_debridementAction_Location = 3;
kat_surgery_debridementAction_MedLevel = 2;
kat_surgery_debrideTime = 20;
kat_surgery_enable_fracture = false;
