...
kat_breathing_death_timer_enable = false;
...
kat_breathing_spo2_big_value = 66;
kat_breathing_spo2_small_value = 30;
...
zen_faction_filter_0_Tban = true;
...
zen_faction_filter_3_AFGCIV = true;
