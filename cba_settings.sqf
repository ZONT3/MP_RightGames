...
force zen_faction_filter_0_Wolfram_AFRF_F = true;
force zen_faction_filter_0_Wolfram_Generic_F = true;
zen_faction_filter_0_Wolfram_Roslav_F = true;
...
force zen_faction_filter_2_Wolfram_Generic_F = true;
