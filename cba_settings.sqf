...
gear_snd_rum_fn = false;
gearP_sdr = 600;
Gforces_fn = false;
gforces_sdr = 1;
Gforces_Vol_fn = false;
gforces_Vol_sdr = 30;
ground_fn = false;
groundP_sdr = 50;
landingVEF_fn = false;
sonicboom_fn = false;
sonicboom_tmp_fn = false;
taxiing_fn = false;
Taxiing_sound_fn = false;
Taxing_sound_fn = false;
TDSound_fn = false;
turbulent_sdr = 10;
turbulent_snd_alarm_fn = false;
turbulent_snd_rum_fn = false;
turbulentH_fn = false;
