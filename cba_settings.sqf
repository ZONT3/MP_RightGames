...
ace_repair_timeCoefficientFullRepair = 3;
...
OPTRE_MJOLNIR_ENABLE_JUMP = false;
...
OPTRE_MJOLNIR_SHOW_DEACTIVATE = true;
OPTRE_MJOLNIR_SHOW_OUTLINE = true;
OPTRE_MJOLNIR_SHOW_OVERLAY = true;
OPTRE_MJOLNIR_SPEED_MODIFIER = 1.1;
...
force OPTRE_POWERED_HELMETS = "LST_Republic_Commando_Helmet_Base,LST_RC_Helmet_Dral,LST_Solus_RC_Helmet_Fudji,LST_RC_Helmet_Venisko,LST_RC_Helmet_Zeus,LST_Solus_RC_Helmet_10_45,LST_Solus_RC_Helmet_Stocker,LST_Foxtrot_RC_Helmet_Gregor,LST_Delta_RC_Helmet_Sev,LST_Delta_RC_Helmet_Scorch,LST_Delta_RC_Helmet_Fixer,LST_Delta_RC_Helmet_Boss";
force OPTRE_POWERED_SUITS_SETTING = "LST_Republic_Commando_Vest_Tech,LST_Republic_Commando_Vest_Sn,LST_Republic_Commando_Vest_EOD,LST_Republic_Commando_Vest_Boss,LST_Omega_Republic_Commando_Vest_Tech,LST_Omega_Republic_Commando_Vest_Sn,LST_Omega_Republic_Commando_Vest_EOD,LST_Omega_Republic_Commando_Vest_Boss,LST_Omega_RC_Helmet";
...
force TFAR_objectInterceptionStrength = 200;
