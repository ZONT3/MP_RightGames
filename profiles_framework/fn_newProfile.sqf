...
[{
  ...
  if _corrupt then {
    hint parseText "<t color='#ff1010'>ОШИБКА В СОХРАНЕНИИ ПРОФИЛЯ</t><br/>Перезайди на сервер.<br/>При повторении - проверь свой ник (в профиле Армы) на наличие пробелов/битых символов в начале/конце. Заново напиши ник.<br/>Либо отпиши в канал #техпомощь если проблема не исчезнет";
  };
