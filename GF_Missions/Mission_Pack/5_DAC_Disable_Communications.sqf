...
_Trigger_EAST_PRESENT setTriggerStatements ["this","",""];
	...
	[GF_Missions_allPlayers,["5_DAC_Disable_Communications","GF_Missions_Pack"],["Disable the Communications","Disable the Communications",""], _Group_Pos,true,1,true,"destroy",true] call BIS_fnc_taskCreate;
