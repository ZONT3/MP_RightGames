...
diag_log "//________________ 9_DAC_Search_Airdrop.sqf _____________";
diag_log "//________________ This is part of of GF Cargo Airdrops Script  _____________";

sleep 2;

	if (GF_Missions_Systemchat_info) then {
	systemchat "9_DAC_Search_Airdrop Initializing";
	};
...
_Distance_to_drop			= 400;        	// Height of drop
_Height_of_drop           	= 500;        	// Height of drop
...
_Building = createVehicle ["PortableHelipadLight_01_yellow_F", GF_Missions_pos, [], 0, "CAN_COLLIDE"];
...
_Trigger_DAC = createTrigger ["Trigger_DAC_9", _Group_Pos];
