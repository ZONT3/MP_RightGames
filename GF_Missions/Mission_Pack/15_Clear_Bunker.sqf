...
_Group_Patrol = [ _Patrol_Pos, EAST, [
...
_Group_Defend = [ _Defend_Pos, EAST, [
"O_G_officer_F","O_G_Soldier_SL_F","O_G_Soldier_TL_F","O_G_Soldier_A_F","O_G_Soldier_AR_F","O_G_medic_F","O_G_engineer_F",
"O_G_Soldier_exp_F","O_G_Soldier_GL_F","O_G_Soldier_M_F","O_G_Soldier_F","O_G_Soldier_LAT_F"
]] call BIS_fnc_spawnGroup;
...
((units _Vehicle_Patrol) select 0) moveInGunner _create_Land_Vehicle;
	...
	[GF_Missions_allPlayers,["15_Clear_Bunker","GF_Missions_Pack"],["Clear Bunker","Clear Bunker",""], _Group_Pos,true,1,true,"attack",true] call BIS_fnc_taskCreate;
	...
	[GF_Missions_allPlayers,["15_Clear_Bunker_2","GF_Missions_Pack"],["Defend the Bunker","Defend the Bunker",""], _Group_Pos,true,1,true,"defend",true] call BIS_fnc_taskCreate;
