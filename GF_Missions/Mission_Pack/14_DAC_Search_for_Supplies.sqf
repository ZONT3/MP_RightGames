...
diag_log "//________________ 14_DAC_Search_for_Supplies.sqf _____________";

sleep 2;

	if (GF_Missions_Systemchat_info) then {
	systemchat "14_DAC_Search_for_Supplies Initializing";
	};
...
_Trigger_DAC = createTrigger ["Trigger_DAC_14", _Group_Pos];
