...
params [["_object", objNull, [objNull]], ["_initialValue", []], ["_whitelist", []]];
...
[_object, _whitelist] remoteExecCall ["jn_fnc_arsenal_init", 0, _JIPID]; // Execute globally, add to the JIP queue
