class JN {
	...
	class Test {
		file = "external\JeroenArsenal\Test";
	...
	class Common {
		file = "external\JeroenArsenal\Common";
	...
	class JNG {
		file = "external\JeroenArsenal\JNG";
		class garage {};
	...
	class Fuel {
		file = "external\JeroenArsenal\Fuel";
	...
	*/
	...
	class Ammo {
		file = "external\JeroenArsenal\Ammo";
	...
	class Repair {
		file = "external\JeroenArsenal\Repair";
	...
	class JNL {
		file = "external\JeroenArsenal\JNL";
	...
	class JNL_Actions {
		file = "external\JeroenArsenal\JNL\Actions";
	...
	class JNL_Functions {
		file = "external\JeroenArsenal\JNL\Functions";
